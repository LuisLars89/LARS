 ...
 // <script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf/1.5.3/jspdf.min.js"></script>
  ...
  function generatePDF() {
    ...
    img.onload = function () {
      ...
      var x = 47; // X coordinate of the image
      ...
      pdf.text("GRACIAS POR SU COMPRA: ", 45, 40);  
      pdf.text("(Datos para realizar pago de su compra) ", 33, 50);    

      pdf.addImage(logo, 'JPEG', xLogo, yLogo);
      pdf.addImage(img, 'JPEG', x, y, width, height);

      // Write the name to the page
      pdf.text(nombre+ ":$ "+precio, 47, 150);
      //pdf.text("$"+precio, 64, 145);
       pdf.text(descripsion, 46, 160);   
